...
!(function (a, b, c, d) {
    ...
    ;(e.Defaults = {
        ...
        (e.Workers = [
            {
                ...
                run: function () {
                    const a = Math.max(this.$element.width(), 326);
                    this._width = a;
                },
            },
            {
            ...
            },
            {
                ...
                run: function (a) {
                    ...
                    else c && ((a.css.width = Math.max(a.items.width, 326)), d.css(a.css))
                },
            },
            {
                filter: ["items"],
        ...
        (e.prototype.onResize = function () {
            return (
                !!this._items.length &&
                this._width !== Math.max(this.$element.width(), 326) &&
                !!this.isVisible() &&
                (this.enter("resizing"),
            ...
            3 !== b.which &&
                (a.support.transform
                    ...
                    : ((d = this.$stage.position()),
                      (d = {
                          x: this.settings.rtl
                              ? d.left + Math.max(this.$stage.width(),326) - Math.max(this.width()) + this.settings.margin
                              : d.left,
                          y: d.top,
                      })),
                this.is("animating") &&
